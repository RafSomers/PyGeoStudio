...
import pandas as pd  # this will be used for when we try for the big excel
...
#######################
src_file = "examples/GeoStudio_files/test_mat.gsz"
...
print(geometry.point_table)
# ig, ax = geometry.draw()   # todo: do we still need the plot?
# plt.show()

# test material assign
mat_ids_used_per_region = context.data["GeometryUsesMaterials"]
mat_ids_used_per_region['Regions-1'] = 4
mat_ids_used_per_region['Regions-6'] = 1
mat_ids_used_per_region['Regions-3'] = 2
mat_ids_used_per_region['Regions-2'] = 3
...
out_file = "examples/GeoStudio_files/test-Model-Builder-HAB-s3.gsz"
